        ...
        while (running)
        {
            ...
            switch (opt)
            {
                ...
                case "4":
                    ...
                    var cDel = clientMgr.FindById(dcid);
                ...
                case "8":
                    ...
                    var sDel = serviceMgr.FindById(dsid);
                ...
                case "12":
                    ...
                    var eDel = employeeMgr.FindById(deId);
                ...
                case "15":
                    ...
                    var apCancel = apptMgr.FindById(caid);
                ...
                case "16":
                    try
                    {
                        ...
                        if (employee == null || serv2 == null)
                        {
                            Console.WriteLine("\nEmployee or service missing.");
                            break;
                        }
